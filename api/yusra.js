...
معلومات الشركة: الرياض (جميع الأحياء) | هاتف: 8695494 57 966+ | واتساب: 3906822 56 966+
  ...
  try {
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      headers: {
        ...
        'HTTP-Referer': 'https://alpha-ultimate.com',
