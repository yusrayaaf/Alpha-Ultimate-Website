      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between gap-4">
        ...
        <NavLink to="/" onClick={() => setOpen(false)} className="flex items-center gap-3 group flex-shrink-0">
          ...
          <div className="leading-none">
            <span className="block text-[15px] font-black tracking-[0.18em] text-white uppercase" style={{ fontFamily: 'Urbanist, sans-serif' }}>Alpha</span>
            <span className="block text-[8px] font-semibold tracking-[0.3em] uppercase" style={{ color: '#FFD166', fontFamily: 'Space Grotesk, sans-serif' }}>Ultimate</span>
          </div>
        </NavLink>
