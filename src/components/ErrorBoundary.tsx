  ...
  render() {
    if (this.state.error) {
      return this.props.fallback ?? (
        <div style={{ background: '#030307', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: 'sans-serif' }}>
          <div style={{ textAlign: 'center', maxWidth: '480px' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <a href="https://wa.me/966578695494" target="_blank" rel="noreferrer"
