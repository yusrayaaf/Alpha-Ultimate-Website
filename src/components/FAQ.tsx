...
const FAQ_EN = [
  ...
  { q: 'How quickly can you come?', a: 'We offer same-day and next-day bookings subject to availability. For urgent requirements, WhatsApp us directly at +966 56 3906822 — we move fast.' },
