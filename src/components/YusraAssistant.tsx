  ...
  const sendMsg = useCallback(async (text?: string) => {
    ...
    try {
      ...
      const fallback = uiLang === 'ar'
        ...
        : 'Sorry, I\'m having trouble. Please call **+966 57 8695494** or WhatsApp **+966 57 869 5494**.';
      ...
      >
        ...
        {!open && speaking && (
          <span className="flex gap-0.5 items-end h-4">
            {[1,2,3].map(i=><motion.span key={i} className="w-0.5 bg-[#030307] rounded-full" animate={{height:['4px','12px','4px']}} transition={{duration:0.6,repeat:Infinity,delay:i*0.12}} />)}
          </span>
        )}
      </motion.button>
            ...
            <div className="flex-shrink-0 p-4 border-t border-white/[0.06] bg-gradient-to-b from-transparent to-black/20">
              ...
              <div className="flex items-center justify-center gap-1.5 mt-3">
                ...
                <a href="https://wa.me/966578695494" target="_blank" rel="noopener noreferrer"
                  ...
                  Prefer WhatsApp? +966 57 869 5494
                </a>
              </div>
            </div>
          </motion.div>
