...
export default function Booking() {
  ...
  if (isSubmitted) {
    return (
      <div className="bg-[#030307] text-white pt-24 pb-20 flex items-center justify-center min-h-screen">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto">
          <motion.form onSubmit={handleSubmit} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.2 }} className="glass-panel p-8 space-y-6">
            {/* Name */}
            <div>
