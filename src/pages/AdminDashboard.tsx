...
function SettingsTab() {
  const [form, setForm] = useState({
    ...
    phone1:'+966578695494 (WhatsApp Only)', phone2:'+16509955661 (Customer Care)',
    email:'info@alpha-01.com', whatsapp:'+966578695494',
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#030307] text-white flex">
      {/* ── Sidebar ── */}
      <aside className={`fixed inset-y-0 left-0 z-40 w-60 admin-sidebar flex flex-col transition-transform duration-300 ${sideOpen?'translate-x-0':'-translate-x-full'} lg:translate-x-0`}>
        {/* Logo */}
      ...
      <div className="flex-1 lg:ml-60 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="sticky top-0 z-20 px-4 sm:px-6 py-3.5 border-b border-white/[0.06] bg-[#030307]/95 backdrop-blur-xl flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
